...
<div class="blog-list-area section-padding">
    ...
    <div class="about-footer-area section-padding">
    <div class="container">
    <div class="row">
    <div class="col-xl-4 col-lg-4 col-md-6">
    <div class="single-about-footer text-center single-sidebar">
    <img src="images/classroom.png" alt="Experienced Trainers">
    <h4>Experienced Trainers</h4>
    <p>SYDTC provide best support and organize training in Bangladesh. They got Updated Lab support.</p>
    </div>
    </div>
    <div class="col-xl-4 col-lg-4 col-md-6">
    <div class="single-about-footer text-center single-sidebar">
    ...
    <h4>Certification</h4>
    <p>We provide BITM Collaborative
    Certification and SYDTC
    Certification.</p> <br>
    </div>
    </div>
    <div class="col-xl-4 col-lg-4 col-md-6">
    <div class="single-about-footer text-center single-sidebar">
    <img src="images/job-support.png" alt="Job Support">
    <h4>Job Support</h4>
    <p>We offer our students effective tools to find employment. Our trainer will help you to achieve the success.</p>
    </div>
    </div>
    </div>
    </div>
