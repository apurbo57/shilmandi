<div class="header-top-are">
    ...
    <input type="hidden" name="_token" value="RJdnBUw4qYHMuuUvVEQfNWg9mbqNqzcriVFpHe5v"> <div class="row">
    <div class="col-xl-12">
    ...
    <a href="" style="font-style: italic !important;
        font-weight: 500 !important;" class="pencilbox-modal-footer-link" data-toggle="modal" data-target="#modalForgetForm" onclick="if (!window.__cfRLUnblockHandlers) return false; document.getElementById('zIndexId').classList.remove('zIndexClass')" data-dismiss="modal" data-cf-modified-e464e61f0656f3579a4b2934-="">Forget
    Password</a>
    </div>
    ...
    Not a member yet? <a href="" class="pencilbox-modal-footer-link" data-toggle="modal" data-target="#modalRegistationForm" onclick="if (!window.__cfRLUnblockHandlers) return false; document.getElementById('zIndexId').classList.remove('zIndexClass')" data-dismiss="modal" data-cf-modified-e464e61f0656f3579a4b2934-="">Register</a>
    </div>
    </div>
    </form>
    </div>
    ...
    <div class="col-xl-12 text-center mt-2 pencilbox-modal-footer-text">
    Back to <a data-dismiss="modal" aria-label="Close" onclick="if (!window.__cfRLUnblockHandlers) return false; document.getElementById('zIndexId').classList.remove('zIndexClass')" class="pencilbox-modal-footer-link" data-cf-modified-e464e61f0656f3579a4b2934-="">Login</a>
    </div>
    </div>
    </form>
    </div>
    ...
    Already a member? <a href="" class="pencilbox-modal-footer-link" data-toggle="modal" data-target="#modalLoginForm" onclick="if (!window.__cfRLUnblockHandlers) return false; document.getElementById('zIndexId').classList.remove('zIndexClass')" data-dismiss="modal" data-cf-modified-e464e61f0656f3579a4b2934-="">Login</a>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="pencilbox-modal-footer-devider"></div>
    <div class="col-xl-12 text-center mt-2 pencilbox-modal-footer-text">
    Back to <a href="" class="pencilbox-modal-footer-link" data-toggle="modal" data-target="#modalLoginForm" onclick="if (!window.__cfRLUnblockHandlers) return false; document.getElementById('zIndexId').classList.remove('zIndexClass')" data-dismiss="modal" data-cf-modified-e464e61f0656f3579a4b2934-="">Login</a>
    </div>
    </div>
    </div>
    </div>
