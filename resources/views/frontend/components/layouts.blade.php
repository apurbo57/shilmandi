<!DOCTYPE html><html class="no-js" lang="en"><head>
    ...
    <script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-131571982-2" type="e464e61f0656f3579a4b2934-text/javascript"></script>
...
<script src="{{ asset('owl-carousel/owl.carousel.js') }}"></script>
 ...
 @include('frontend.components.header')
    ...
    <style>
        ...
        .per-card:hover {
            box-shadow: 0px 0px 10px #fcb315 !important;
        }
        .per-count {
            font-weight: 500;
            font-size: 40px;
        ...
        .per-call:hover .per-count, .per-call:hover .count_homepage {
    ...
    @media  screen and (min-width:320px) and (max-width:992px) {
        ...
        .home_bg_left_small{
            background: url("images/cover_for_homepage_left.webp");
            background-repeat : no-repeat;
            background-size : 100% auto !important;
        }
        .home_bg_left_small>img{
            width:100% !important;
        }
        .home_bg_right_small{
            background: url("images/cover_for_homepage_right.webp");
            background-repeat : no-repeat;
            background-size : 100%;
    ...
    <button id="return_top" onclick="if (!window.__cfRLUnblockHandlers) return false; topFunction()" data-cf-modified-e464e61f0656f3579a4b2934-=""><img src="images/pencilbox-06b.png" loading="lazy"></button>
    ...
    $('#email_address_registration').focusout(function () {
        ...
        $.ajax({
            ...
            type: "post",
            data: { 
                "_token": "RJdnBUw4qYHMuuUvVEQfNWg9mbqNqzcriVFpHe5v",
    ...
    <script type="e464e61f0656f3579a4b2934-application/javascript">
        if ("") {
            swal({
                title: "Warning!",
                text: "",
    ...
    <script type="e464e61f0656f3579a4b2934-text/javascript">
                $( "#selectCourse" ).on( "change", function() {
                    // var training_id= $("#selectCourse option: selected").val();
                    var batch_id= $("#selectCourse").find(':selected').attr('batch_id')
                    //   var training_id= $('#selectCourse').find(":selected").attr(training_id);
    ...
    <script type="e464e61f0656f3579a4b2934-text/javascript">
                    jQuery(function($) {
                        ...
                        /*
                            pop wil show once per session. After closing browser it will popup again=====start====
                        */
                        ...
                        // if(getCookie("popup") == 'seen' && sessionStorage.getItem("popup") != 'seen' ){
                        //     $(".seip_popup_button").show();
                        //     $("#pb_counter_modal").removeClass('d-none');
                        //     // if( sessionStorage.getItem("popup") != 'seen' ){
                        //         setCookie("popup", 'removed', 1);
                        //     // }else{
                        //         // document.cookie = 'popup=removed; expires=Fri, 3 Aug 2012 20:47:11 UTC; path=/';
                        //     // }
                        // }else 
                        if(sessionStorage.getItem("popup") != 'seen'){
                            ...
                            setTimeout(function() {
                                $(".seip_addmission_modal").animate({width: "100%" , height: "100%", opacity:"1"},800);
                                // $(".seip_addmission_modal .home_bg_X").fadeIn(2000);
                                $(".seip_addmission_popup_overlay").removeClass('d-none');
                                $("#pb_counter_modal").removeClass('d-none');
                                $("body").addClass('seip_modal_body_class');
                            }, 4500); 
                        }else{
                            $(".seip_popup_button").show();
                            $("#pb_counter_modal").removeClass('d-none');
                        ...
                        /*
                            popup wil show once per session. After closing browser it will popup again=====End====
                        */
                        
                        
                        $(".seip_addmission_popup_close i").click(function() {
                            $(".seip_addmission_modal").animate({width: "0" , height: "0", opacity:"0"},800);
                            $(".seip_addmission_modal .home_bg_X").fadeOut(300);
                            // $("#pb_counter_modal").fadeOut(300);
                            $("#pb_counter_modal").addClass('d-none');
                            $(".seip_addmission_popup").slideUp(300);
                            $("body").removeClass('seip_modal_body_class');
                            $(".seip_popup_button").slideDown(200);
                        });
                        $(".seip_popup_button").click(function() {
                            $(".seip_addmission_modal").animate({width: "100%" , height: "100%", opacity:"1"},800);
                            $(".seip_addmission_modal .home_bg_X").fadeIn(300);
                            // $("#pb_counter_modal").fadeIn(300);
                            $(".seip_addmission_popup").slideDown(300);
                            $("body").addClass('seip_modal_body_class');
                            $(".seip_popup_button").slideUp(200);
                            $(".seip_addmission_popup_overlay").removeClass('d-none');
                            $("#pb_counter_modal").removeClass('d-none');
                        });
                    });
    ...
    <script type="e464e61f0656f3579a4b2934-text/javascript">
                    ...
                    $(document).ready(function () {
                        //display dynamic dropdown menu name
                        $('.filter-button-group').click(function (event) {
                            $('#ui-id-1 span').text($(event.target).text());
                            // console.log($(event.target).text());
                        })
                        //   init course tabs
                        $( function() {
                            $( "#all_course_tabs" ).tabs({
                                active: 1,
                        ...
                        $(".dropdown").click(function(){
                            ...
                            $('#tab_buttons a.nav-link.dropdown_button').toggleClass('dropdown_active');
                        });
                        //   all course dropdown outside click handle
                        $(document).on("click", function(event){
                            var $trigger = $(".dropdown");
                            if($trigger !== event.target && !$trigger.has(event.target).length){
                                $(".dropdown-menu").slideUp("fast");
                                $('#tab_buttons a.nav-link.dropdown_button').removeClass('dropdown_active');
                            }
                        });
                        /*
                        all course filter with button content with jQuery
                        */
                        var total_element = $("div.pb_single_course_col_all").length;
                        var total_hidden_element = total_element - 6;
                        var $btns = $('.all_course_filter_btn').click(function(e){
                            var all_elements = [];
                            if (this.id == 'all_course_filter_all') {
                                // $("div.pb_single_course_col_all").slice(0, 6).show();
                                $("div.pb_single_course_col_all").hide();
                                $("div.pb_single_course_col_all:lt(6)").show();
                                $("#all_More").removeClass("d-none");
                            } else {
                                var $el = $('.' + this.id).fadeIn(450);
                                $('.pb_single_course_col_all').not($el).hide();
                                $("#all_More").addClass("d-none");
                            }
                        });
                        /*
                        all course filter with button content with jQuery
                    ...
                    // load more all courses
                            $("div.pb_single_course_col_all").slice(0, 6).show();
                            $("#all_More").on('click', function (e) {
                            // e.preventDefault();
                                $("div.pb_single_course_col_all:hidden").slice(0, 3).slideDown();
                                if ($("div.pb_single_course_col_all:hidden").length == 0) {
                                    $("#all_More").text("No Content").addClass("d-none");
                                }
                            });
                            // load more upcoming courses
                            $("div.pb_single_course_col").slice(0, 9).show();
                            $("#up").on('click', function (e) {
                                e.preventDefault();
                                $("div.pb_single_course_col:hidden").slice(0, 3).slideDown();
                                if ($("div.pb_single_course_col:hidden").length == 0) {
                                    $("#up").text("No Content").addClass("d-none");
                                }
                            });
                            // load more old courses
                            $("div.pb_single_course_col_old").slice(0, 6).show();
                            $("#old").on('click', function (e) {
                                e.preventDefault();
                                $("div.pb_single_course_col_old:hidden").slice(0, 3).slideDown();
                                if ($("div.pb_single_course_col_old:hidden").length == 0) {
                                    $("#old").text("No Content").addClass("d-none");
                                }
                            });
                            // load more onigoing courses
                            $("div.pb_single_course_col_ongoing").slice(0, 6).show();
                            $("#ongoing").on('click', function (e) {
                                e.preventDefault();
                                $("div.pb_single_course_col_ongoing:hidden").slice(0, 3).slideDown();
                                if ($("div.pb_single_course_col_ongoing:hidden").length == 0) {
                                    $("#ongoing").text("No Content").addClass("d-none");
                                }
                            });
                            // load more collaborative courses
                            $("div.pb_single_course_col_colla").slice(0, 6).show();
                            $("#colla").on('click', function (e) {
                                e.preventDefault();
                                $("div.pb_single_course_col_colla:hidden").slice(0, 3).slideDown();
                                if ($("div.pb_single_course_col_colla:hidden").length == 0) {
                                    $("#colla").text("No Content").addClass("d-none");
                                }
                            });
                        });
                        // ==== ongoing course vertical tab slider ====
                        $('.slick-slider').slick({
                            vertical: true,
                            slidesToShow: 4,
                            slidesToScroll: 1,
                        ...
                        // ========== ongoing course lider image show=======
                        setInterval(function(){
                        var slider_img = $(".ongoing_courses_tab_slider .slick-slider").find(".slick-current .ongoing_course_slider_img").html();
                            $(".tab-content #ongoing_course_tab_item").html(slider_img);
                        }, 100);
